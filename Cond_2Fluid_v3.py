...
nmax=200; mmax=200
kmax=11; ro=1.5**3; mu=1.5**2; a0=.2; nu=mu/ro; us0=a0/mu
...
for k in range(kmax):
    wm[0,k]=1./mu; wm[1,k]=1./mu
    vm[1,k]=0.; vm[1,k]=0.
    um[0,k]=a0*z[k]/mu; um[1,k]=a0*z[k]/mu
...
#PRESSURE JUMP SPECIFIED HERE
    r1=dy*(0+(1-ro)*usold*(3.*usold-4*us[n-1]+us[n-2])/2/dx)
    r2=mu*dy/dz/H
